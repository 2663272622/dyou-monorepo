(function () {
  ...
  var showDialog = function (editor) {
    ...
    var body = {
      type: 'panel',
      items: [
        { type: 'input', name: 'headerText', label: '章头文字', value: initialData.headerText || '' },
        { type: 'colorinput', name: 'textColor', label: '文字颜色', value: initialData.textColor || '#000000' },
        { type: 'colorinput', name: 'bgColor', label: '背景颜色', value: initialData.bgColor || '#ffffff' },
        {
          type: 'selectbox',
          name: 'borderStyle',
          label: '边框样式',
          ...
          value: initialData.borderStyle || 'solid'
        },
        { type: 'colorinput', name: 'borderColor', label: '边框颜色', value: initialData.borderColor || '#000000' },
        { type: 'input', name: 'borderWidth', label: '边框宽度', value: initialData.borderWidth || '1' }
      ]
    };
    ...
    editor.windowManager.open({
      ...
      onSubmit: function (api) {
        ...
        const content = createChapterHeader({ serviceData });
  ...
  function Plugin() {
    global.add('chapterHeader', function (editor) {
      ...
      editor.on('dblclick', function (e) {
        var target = e.target.closest('.chapter-header');
        if (target) {

   ...
   <div class="app-container">
      ...
      <el-table  stripe  v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="操作" align="center" width="180" class-name="small-padding fixed-width" fixed="right">
            <template #default="scope"> 
                <el-button link type="primary" icon="Edit" @click="handleUpdate(1,scope.row)" v-hasPermi="['manage:publisher:edit']">公库</el-button>
                <el-button link type="primary" icon="Edit" @click="handleUpdate(2,scope.row)" v-hasPermi="['manage:publisher:edit']">私库</el-button>
            </template>
         </el-table-column>
      </el-table>
...
import { bookshelfApi,bookDelApi,upOrDownAddApi,submitReviewApi } from "@/api/press/digitalTextbook"
...
function getList() {
  loading.value = true;
  bookshelfApi(queryParams.value).then(response => {

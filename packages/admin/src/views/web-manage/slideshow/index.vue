    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
            ...
            plain
            icon="Plus"
            v-hasPermi="['manage:resource:add']"
            @click="handleAdd"
        >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            icon="Edit"
            :disabled="single"
            v-hasPermi="['manage:resource:edit']"
            @click="handleUpdate"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            icon="Delete"
            :disabled="multiple"
            v-hasPermi="['manage:resource:remove']"
            @click="handleDelete"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
            ...
            plain
            icon="Download"
            v-hasPermi="['manage:resource:export']"
            @click="handleExport"
        >导出
        </el-button>
      </el-col>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-tooltip content="修改" placement="top">
            <el-button link type="primary" icon="Edit"  v-hasPermi="['manage:resource:edit']" @click="handleUpdate(scope.row)"></el-button>
          </el-tooltip>
          <el-tooltip content="删除" placement="top">
            <el-button link type="primary" icon="Delete"  v-hasPermi="['manage:resource:export']" @click="handleDelete(scope.row)"></el-button>
          </el-tooltip>
        </template>
      </el-table-column>
    </el-table>

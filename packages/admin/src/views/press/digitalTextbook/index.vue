 ...
 <template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="字数" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="书籍定价" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="价格" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="ISBN" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="教学层次" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="学科分类" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="二级分类" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="标签" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="定价" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="责任编辑电话" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="出版日期" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         <el-table-column label="合作院校" align="center" prop="phone"  width="200" :show-overflow-tooltip="true"/>
         ...
         <el-table-column label="操作" align="center" width="300" class-name="small-padding fixed-width" fixed="right">
            <template #default="scope">
               ...
               <!-- <el-button link type="primary" icon="Pointer" @click="handleUpdate(3,scope.row)" v-hasPermi="['manage:publisher:Open']">上架</el-button> -->
               <el-button link type="primary" icon="Edit" @click="handleUpdate(4,scope.row)" v-hasPermi="['manage:publisher:TurnOff']">下架</el-button>
               <el-button link type="primary" icon="Delete" @click="handleUpdate(5,scope.row)" v-hasPermi="['manage:publisher:remove']">删除</el-button>
            </template>
         </el-table-column>
      </el-table>
